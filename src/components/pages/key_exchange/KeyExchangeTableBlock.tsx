...
import KeyExchangeFilesTable from '../../tables/KeyExchangeFilesTable';
...
interface IKeyExchangeTableBlock {
    selectedID: number
   }

const KeyExchangeTableBlock = ({
    selectedID
}: IKeyExchangeTableBlock) => {

    const componentName = 'KeyExchangeTableBlock'
    ...
    const { data: filesData, isFetching: isFetchingFilesData, error: errorFilesData, refetch: refetchFilesData } = useGetFilesQuery(
        { model_type: 'KeyExchangeProjects', number: selectedID, active: 'True', deleted: 'False' }
    )
                ...
                actions={[
                    {
                        ...
                        onClick: () => {
                            dispatch(setModalProps({componentName: 'AddNewFileModal', data: {
                                objChangedData: {
                                    model_type: "KeyExchangeProjects",
                                    number: selectedID,
                                    action: 'add-new-file'
                                },
                                other: {
...
export default KeyExchangeTableBlock;