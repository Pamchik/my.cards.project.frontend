...
import BankPriceInfo from './BankPriceInfo';
...
const PaymentsBank = ({
    ...
    return (
        <>
            ...
            <ElementSpoiler spoilerTitle={'Данные по оплате (Банк)'} myStyleMain={{}} isSpoilerDisabled={true}>
                <BankPriceInfo
                    selectedID={selectedID}
                />
