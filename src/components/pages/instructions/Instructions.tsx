...
import InstructionsTable from '../../tables/InstructionsTable';
...
const Instructions = () => {
    ...
    const { data: filesTableData, isFetching: isFetchingFilesTableData, error: errorFilesTableData, refetch: refetchFilesTableData } = useGetFilesTableQuery(
        { active, model_type: 'Instructions', deleted: 'False' },
        { 
            skip: !shouldFetch,
                    ...
                    <ButtonMain
                        ...
                        actions={[
                            ...
                            },
                            {
                                ...
                                onClick: () => {dispatch(setResetTableParams({type: 'filters', tableName: 'InstructionsTableStateLocalStorage'}))}
                            },
                            {
                                name: "Сбросить настройки таблицы", 
                                onClick: () => {dispatch(setResetTableParams({type: 'allParams', tableName: 'InstructionsTableStateLocalStorage'}))}
                            },                            
                        ]}
                    />       
                </div>
