...
interface ICardsTestingProjectMainData {
    selectedID: number
}

const CardsTestingProjectMainData = ({
    selectedID,
}: ICardsTestingProjectMainData) => {

    const componentName = 'CardsTestingProjectMainData'
...
export default CardsTestingProjectMainData