...
import { useAddMifareMutation, useUpdateMifareMutation } from "../../store/api/mifareApiSlice";
import { useAllComponentParamsReset } from "../hooks/useComponentDataReset";
import useTimeoutManager from "../hooks/useTimeoutManager";


const CreateNewMifareModal = () => {

    const componentName = 'CreateNewMifareModal'
    ...
    const [addMifare, {}] = useAddMifareMutation()
        ...
        {isComponentPrepared && (<>
            ...
            >
                ...
                <MainModalTopBlock>
                    ...
                    <MainModalText modalTitle={`${componentData?.objInputData?.['id'] ? 'Изменение типа Mifare' : 'Создание нового типа Mifare'}`}/>
...
export default CreateNewMifareModal