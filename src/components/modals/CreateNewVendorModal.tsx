...
import { useAddVendorMutation, useUpdateVendorMutation } from "../../store/api/vendorApiSlice";
...
const CreateNewVendorModal = () => {
    ...
    const componentName = 'CreateNewVendorModal'
        ...
        {isComponentPrepared && (<>
            ...
            >
                ...
                <MainModalTopBlock>
                    ...
                    <MainModalText modalTitle={`${componentData?.objInputData?.['id'] ? 'Изменение Вендора' : 'Создание Вендора'}`}/>
