...
import { useAddEffectMutation, useUpdateEffectMutation } from "../../store/api/effectApiSlice";
...
const CreateNewEffectModal = () => {

    const componentName = 'CreateNewEffectModal'
        ...
        {isComponentPrepared && (<>
            ...
            >
                ...
                <MainModalTopBlock>
                    ...
                    <MainModalText modalTitle={`${componentData?.objInputData?.['id'] ? 'Изменение Эффекта"' : 'Создание Эффекта'}`}/>
                ...
                <MainModalMainBlock myStyleMainBlock={{ display: 'flex', minHeight: '250px'}}>
                    <ContentBlock>
                        ...
                        <BlockInput
                            ...
                            isReadOnly={!!modalsPropsData?.objReadOnlyFields?.includes('common_name_rus')}
                        ...
                        <BlockInput
                            ...
                            isReadOnly={!!modalsPropsData?.objReadOnlyFields?.includes('common_name_eng')}
...
export default CreateNewEffectModal