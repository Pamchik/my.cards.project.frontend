...
const InstructionsTable = ({
    ...
    const tableStateLocalStorageName = 'InstructionsTableStateLocalStorage'
    ...
    // Проверяем и загружаем сохраненное состояние из localStorage при первой загрузке
        useEffect(() => {
            const savedState = localStorage.getItem('InstructionsTableStateLocalStorage');
            if (savedState) {
