...
export interface IStartYearsData {
    id: number,
    year_number: number
}

export const startYearApi = createApi({
    reducerPath: 'startYearApi',
    ...
    endpoints: (build) => ({
        getStartYears: build.query<IStartYearsData[], void>({
            query: () => ({
                url: '/api/start-year/',
            }),
        })   
